...
| -------------------------------------------------------------------*/
	...
	/** Toma el path de la url relativo al ambiente que se este utilizando **/	
	$path = strstr($_SERVER['REQUEST_URI'], "custom/jk/jkondor", true);
	$img_path = $path . "uploads/docs_images";
	
// 	$config['img_path'] = '/images'; // Relative to domain name
	$config['img_path'] = $img_path; // Relative to domain name

	
	/** Toma el path absoluto del ambiente que se este utilizando **/	
	$path = strstr($_SERVER['SCRIPT_FILENAME'], "custom/jk/jkondor", true);
	$upload_path = $path . "uploads/docs_images";
	
// 	$config['upload_path'] = "/var/www/images"; // Physical path.
	$config['upload_path'] = $upload_path; // Physical path.
